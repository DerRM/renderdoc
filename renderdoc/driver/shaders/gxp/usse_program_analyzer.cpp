...
#include <driver/shaders/gxp/gxm/functions.h>
#include <driver/shaders/gxp/gxm/types.h>
#include <driver/shaders/gxp/shader/gxp_parser.h>
#include <driver/shaders/gxp/shader/usse_program_analyzer.h>

#include <cassert>

#include <driver/shaders/gxp/shader/usse_types.h>
...
std::uint8_t get_predicate(const std::uint64_t inst) {
    ...
    case 0b11111: {
        ...
        if ((((inst >> 32) & ~0xF8FFFFFF) >> 24) == 1 && ((inst >> 32) & ~0xFFCFFFFF) >> 20 == 3) {
            uint8_t pred = (uint8_t)(((inst >> 32) & 0xFFFFF9FF) >> 9);
            switch (pred) {
            case 0:
