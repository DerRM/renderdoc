...
template <>
rdcstr DoStringise(const SceGxmAttributeFormat &el)
{
  BEGIN_ENUM_STRINGISE(SceGxmAttributeFormat);
  {
    STRINGISE_ENUM(SCE_GXM_ATTRIBUTE_FORMAT_U8)
    STRINGISE_ENUM(SCE_GXM_ATTRIBUTE_FORMAT_S8)
    STRINGISE_ENUM(SCE_GXM_ATTRIBUTE_FORMAT_U16)
    STRINGISE_ENUM(SCE_GXM_ATTRIBUTE_FORMAT_S16)
    STRINGISE_ENUM(SCE_GXM_ATTRIBUTE_FORMAT_U8N)
    STRINGISE_ENUM(SCE_GXM_ATTRIBUTE_FORMAT_S8N)
    STRINGISE_ENUM(SCE_GXM_ATTRIBUTE_FORMAT_U16N)
    STRINGISE_ENUM(SCE_GXM_ATTRIBUTE_FORMAT_S16N)
    STRINGISE_ENUM(SCE_GXM_ATTRIBUTE_FORMAT_F16)
    STRINGISE_ENUM(SCE_GXM_ATTRIBUTE_FORMAT_F32)
    STRINGISE_ENUM(SCE_GXM_ATTRIBUTE_FORMAT_UNTYPED)
  }
  END_ENUM_STRINGISE();
}
...
template <>
rdcstr DoStringise(const SceGxmParameterType &el)
{
  BEGIN_ENUM_STRINGISE(SceGxmParameterType);
  {
    STRINGISE_ENUM(SCE_GXM_PARAMETER_TYPE_F32)
    STRINGISE_ENUM(SCE_GXM_PARAMETER_TYPE_F16)
    STRINGISE_ENUM(SCE_GXM_PARAMETER_TYPE_U32)
    STRINGISE_ENUM(SCE_GXM_PARAMETER_TYPE_S32)
    STRINGISE_ENUM(SCE_GXM_PARAMETER_TYPE_U16)
    STRINGISE_ENUM(SCE_GXM_PARAMETER_TYPE_S16)
    STRINGISE_ENUM(SCE_GXM_PARAMETER_TYPE_C10)
    STRINGISE_ENUM(SCE_GXM_PARAMETER_TYPE_S8)
    STRINGISE_ENUM(SCE_GXM_PARAMETER_TYPE_U8)
    STRINGISE_ENUM(SCE_GXM_PARAMETER_TYPE_AGGREGATE)
  }
  END_ENUM_STRINGISE();
}
