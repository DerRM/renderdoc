...
{
    sceClibPrintf("sceGxmDestroyDeferredContext(context: %p)\n", context);
...
{
    sceClibPrintf("sceGxmEndCommandList(deferredContext: %p, commandList: %p)\n", deferredContext, commandList);
...
{
    sceClibPrintf("sceGxmExecuteCommandList(immediateContext: %p, commandList: %p)\n", immediateContext, commandList);
...
{
    sceClibPrintf("sceGxmFragmentProgramGetPassType(fragmentProgram: %p)\n", fragmentProgram);
...
{
    sceClibPrintf("sceGxmFragmentProgramIsEnabled(fragmentProgram: %p)\n", fragmentProgram);
...
{
    sceClibPrintf("sceGxmGetContextType(context: %p, type: %p)\n", context, type);
...
{
    sceClibPrintf("sceGxmGetDeferredContextFragmentBuffer(deferredContext: %p, mem: %p)\n", deferredContext, mem);
...
{
    sceClibPrintf("sceGxmGetDeferredContextVdmBuffer(deferredContext: %p, mem: %p)\n", deferredContext, mem);
...
{
    sceClibPrintf("sceGxmGetDeferredContextVertexBuffer(deferredContext: %p, mem: %p)\n", deferredContext, mem);
...
{
    sceClibPrintf("sceGxmGetParameterBufferThreshold(parameterBufferSize: %p)\n", parameterBufferSize);
...
{
    sceClibPrintf("sceGxmIsDebugVersion()\n");
...
{
    sceClibPrintf("sceGxmProgramGetFragmentProgramInputs(program: %p)\n", program);
...
{
    sceClibPrintf("sceGxmProgramGetOutputRegisterFormat(program: %p, type: %p, componentCount: %p)\n", program, type, componentCount);
...
{
    sceClibPrintf("sceGxmProgramGetVertexProgramOutputs(program: %p)\n", program);
...
{
    sceClibPrintf("sceGxmProgramIsEquivalent(programA: %p, programB: %p)\n", programA, programB);
...
{
    sceClibPrintf("sceGxmProgramIsFragColorUsed(program: %p)\n", program);
...
{
    sceClibPrintf("sceGxmProgramIsNativeColorUsed(program: %p)\n", program);
...
{
    sceClibPrintf("sceGxmProgramParameterGetIndex(program: %p, parameter: %p)\n", program, parameter);
...
{
    sceClibPrintf("sceGxmProgramParameterIsRegFormat(program: %p, parameter: %p)\n", program, parameter);
...
{
    sceClibPrintf("sceGxmRemoveRazorGpuCaptureBuffer(base: %p)\n", base);
...
{
    sceClibPrintf("sceGxmSetDefaultRegionClipAndViewport(context: %p, xMax: %" PRIu32 ", yMax: %" PRIu32 ")\n", context, xMax, yMax);
...
{
    sceClibPrintf("sceGxmSetDeferredContextFragmentBuffer(deferredContext: %p, mem: %p, size: %" PRIu32 ")\n", deferredContext, mem, size);
...
{
    sceClibPrintf("sceGxmSetDeferredContextVdmBuffer(deferredContext: %p, mem: %p, size: %" PRIu32 ")\n", deferredContext, mem, size);
...
{
    sceClibPrintf("sceGxmSetDeferredContextVertexBuffer(deferredContext: %p, mem: %p, size: %" PRIu32 ")\n", deferredContext, mem, size);
...
{
    sceClibPrintf("sceGxmSetFragmentDefaultUniformBuffer(context: %p, bufferData: %p)\n", context, bufferData);
...
{
    sceClibPrintf("sceGxmSetVertexDefaultUniformBuffer(context: %p, bufferData: %p)\n", context, bufferData);
...
{
    sceClibPrintf("sceGxmSetWarningEnabled(warning: %" PRIu32 ", enable: %s)\n", warning, enable ? "true" : "false");
...
{
    sceClibPrintf("sceGxmSetYuvProfile(immediateContext: %p, cscIndex: %" PRIu32 ", profile: %" PRIu32 ")\n", immediateContext, cscIndex, profile);
...
{
    sceClibPrintf("sceGxmTextureGetLodMin(texture, %p)\n", texture);
...
{
    sceClibPrintf("sceGxmTextureGetMipmapCountUnsafe(texture, %p)\n", texture);
...
{
    sceClibPrintf("sceGxmTextureGetNormalizeMode(texture, %p)\n", texture);
...
{
    sceClibPrintf("sceGxmTextureGetUAddrModeSafe(texture, %p)\n", texture);
...
{
    sceClibPrintf("sceGxmTextureGetVAddrModeSafe(texture, %p)\n", texture);
...
{
    sceClibPrintf("sceGxmTextureInitCubeArbitrary(texture, %p, data: %p, texFormat: %" PRIu32 ", width: %" PRIu32 ", height: %" PRIu32 ", mipCount: %" PRIu32 ")\n", texture, data, texFormat, width, height, mipCount);
...
{
    sceClibPrintf("sceGxmTextureInitSwizzledArbitrary(texture, %p, data: %p, texFormat: %" PRIu32 ", width: %" PRIu32 ", height: %" PRIu32 ", mipCount: %" PRIu32 ")\n", texture, data, texFormat, width, height, mipCount);
...
{
    sceClibPrintf("sceGxmTextureSetLodMin(texture, %p, lodMin: %" PRIu32 ")\n", texture, lodMin);
...
{
    sceClibPrintf("sceGxmTextureSetNormalizeMode(texture, %p, mipCount: %" PRIu32 ")\n", texture, normalizeMode);
...
{
    sceClibPrintf("sceGxmTextureSetUAddrModeSafe(texture, %p, addrMode: %" PRIu32 ")\n", texture, addrMode);
...
{
    sceClibPrintf("sceGxmTextureSetVAddrModeSafe(texture, %p, addrMode: %" PRIu32 ")\n", texture, addrMode);
...
{
    sceClibPrintf("sceGxmTextureValidate(texture, %p)\n", texture);
...
{
    sceClibPrintf("sceGxmTransferFill(fillColor: %" PRIu32 ", destFormat: %" PRIu32 ", destAddress: %p, destX: %" PRIu32 ", destY: " PRIu32 ", destStride: %" PRIu32 ", syncObject: %p, syncFlags: %" PRIu32 ", notification: %p)\n", fillColor, destFormat, destAddress, destX, destY, destStride, syncObject, syncObject, notification);
...
{
    sceClibPrintf("sceGxmVertexFence()\n");
